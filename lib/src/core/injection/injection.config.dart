...
import 'package:time_listener/time_listener.dart' as _i6;
import 'package:wakeme/src/core/injection/modules/debounce_module.dart' as _i11;
import 'package:wakeme/src/core/injection/modules/router_module.dart' as _i13;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i6.TimeListener>(() => timeListenerModule.instance);
    gh.factory<_i7.AlarmDetailsScreenCubit>(() => _i7.AlarmDetailsScreenCubit(
          gh<_i4.EasyDebouncer>(),
          gh<_i6.TimeListener>(),
        ));
    gh.factory<_i8.BuzzersLocalSource>(
        () => _i8.BuzzersLocalSource(gh<_i5.HiveClient>()));
...
class _$TimeListenerModule extends _i12.TimeListenerModule {}
